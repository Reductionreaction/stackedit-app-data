...
## 7. 数据库的物理储存介质
三级储存器结构：
主存储器（cache高速缓冲存储器，主存储器）($10^{-7}s$)
磁盘存储器（10ms）
辅助存储器：磁带存储器，自动光盘机（顺序访问，几秒钟）
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY1OTE1MTY0MCwtMTcxMzA5MzQ0MiwtNj
U4ODExNjQsLTMyOTk0ODE1NywxOTY3NTkwMDMyLDE4NTMzNDAw
MzMsLTE5MDk5MzQyMTUsLTExMjUzNTgxMzMsNzIyNTI3Mjc0LC
0xNDY4MzUwMDgyLC0xNzkzMTY2Mjc5LDYwMjM5ODcxNywtMjA5
MDIyMTY5OCwtMTg5NDc5MTg1NiwtMTY5ODc5NDczOSwtMzM5MD
c5MDA5LC02MDU4MjAyMzksLTE3MDkwNDQwMTIsLTE0ODUwMTc0
MDUsMTcwOTMwNTM1XX0=
-->