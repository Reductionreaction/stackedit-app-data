...
**计算机引导过程**
bios(可以访问io设备, 检测硬件) $\rightarrow$ 读取磁盘驱动0号扇区(55 aa?) $\rightarrow$ 跳转到对应地址MBR(硬件厂商确定格式) $\rightarrow$(这里有一步grub或者lilo) 加载kernel到主存

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY1NTIzODM3LC0xMjU4NDg5ODg4LDE5OD
I5NjM5MzgsNDgxMDAxMjkyLC0xMDkzMDMxNjcxLC0yMDI2MTE0
NjIyLDQxNzk1NDc4MywxMzc0MDgxMzAyLDE4NzY2MzMyMDAsNj
QzNjAyOTIyLC0xODc0NzIwNzYyXX0=
-->