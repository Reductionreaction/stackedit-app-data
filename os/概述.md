...
**计算机引导过程**
bios(可以访问io设备, 检测硬件) $rightarrow$ 读取磁盘驱动0号扇区(55 aa?) $rightarrow$ 跳转到对应地址MBR(硬件厂商确定格式) $rightarrow$ 加载kernel到主存

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ4OTExMTI2MiwtMTI1ODQ4OTg4OCwxOT
