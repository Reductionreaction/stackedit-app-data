...
idle 0 填满cpu使用时间
**os是中断驱动的**
- io设备通知cpu(有int引脚或控制芯片(可以并联)$\rightarrow$接受io设备的电信号, 发生变化后读取中断寄存器$\rightarrow$硬件提供机制,查中断向量表(一组地址,硬件定义长度),执行对应地址上的代码)
- 初始化os时会初始化一个定时器: 每隔一段时间产生一个中断
- 

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExNDQxMzc2MjAsMTIwMzAxODk1OCwxNT
MwNzQ3NjUxLC03MjI4Mjg2ODgsMTQ2NDg0ODI2OSwtMTI1ODQ4
OTg4OCwxOTgyOTYzOTM4LDQ4MTAwMTI5MiwtMTA5MzAzMTY3MS
wtMjAyNjExNDYyMiw0MTc5NTQ3ODMsMTM3NDA4MTMwMiwxODc2
NjMzMjAwLDY0MzYwMjkyMiwtMTg3NDcyMDc2Ml19
-->