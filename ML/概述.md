...
eg: 假设三个维度各有3种可能的情况，则假设空间的规模为
	$4*4*4+1=65$ $\rightarrow$ 这里的第四种情况是和这个维度无关，即取任意值都可以，最后一种是对前提的否定：即世界上不存在好瓜
**版本空间** ： 即和训练集一致的假设集合
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NzEzOTA5NzcsMTE4Njc1MTAwOSwtNT
gyNzE3MDAzLDYyMzE1MzUwNCwtNjA3MTIwMzE5LC03ODAzNjIx
OSwtMTE1NTc1NDYxMSwtMTI4MzYzNDg2N119
-->