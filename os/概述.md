...
**计算机引导过程**
bios(可以访问io设备, 检测硬件) $\rightarrow$ 读取磁盘驱动0号扇区(55 aa?) $\rightarrow$ 跳转到对应地址MBR(硬件厂商确定格式) $\rightarrow$(这里还有一步跳转到grub或者lilo) 加载kernel到主存 $\rightarrow$ init进程, 读取配置文件, 启动服务

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUzMDc0NzY1MSwtNzIyODI4Njg4LDE0Nj
Q4NDgyNjksLTEyNTg0ODk4ODgsMTk4Mjk2MzkzOCw0ODEwMDEy
OTIsLTEwOTMwMzE2NzEsLTIwMjYxMTQ2MjIsNDE3OTU0NzgzLD
EzNzQwODEzMDIsMTg3NjYzMzIwMCw2NDM2MDI5MjIsLTE4NzQ3
MjA3NjJdfQ==
-->