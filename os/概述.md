...
**计算机引导过程**
bios(可以访问io设备, 检测硬件) $\rightarrow$ 读取磁盘驱动0号扇区(55 aa?) $\rightarrow$ 跳转到对应地址MBR(硬件厂商确定格式) $\rightarrow$(这里还有一步grub或者lilo) 加载kernel到主存

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ2NDg0ODI2OSwtMTI1ODQ4OTg4OCwxOT
gyOTYzOTM4LDQ4MTAwMTI5MiwtMTA5MzAzMTY3MSwtMjAyNjEx
NDYyMiw0MTc5NTQ3ODMsMTM3NDA4MTMwMiwxODc2NjMzMjAwLD
Y0MzYwMjkyMiwtMTg3NDcyMDc2Ml19
-->