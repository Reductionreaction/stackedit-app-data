...
- 读入操作: 用out不断读取状态寄存器判断是否空闲, 发送读取命令, 用out对port进行写控制寄存器操作, 继续读状态寄存器, 写入数据寄存器直到free, 用In指令读到cpu中, 再用mov写到主存 $\rightr$
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY0NzMzMzI4NiwtMTQ4NTExOTY5NywtNz
E0MzY1MDM0LC0xNTE2MTMxNjQ5LDE3MjE0MTg3MTIsNjA4ODIx
MjE5LC02NTQyNjYwNTIsLTczMjc0NTMxMCwxNzgyOTE2MDI1LC
0xMDcyNjQ5OTIyLC0xMjA4NTU2MTIxLDE3MjIxNjc1OCwtMTcy
NTEwMjYzMCwtMTcyNTEwMjYzMCw4NTY5MzkzNTgsMTIwMzAxOD
k1OCwxNTMwNzQ3NjUxLC03MjI4Mjg2ODgsMTQ2NDg0ODI2OSwt
MTI1ODQ4OTg4OF19
-->